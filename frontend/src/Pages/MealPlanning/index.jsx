...
function Recipies() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQQKHCORb8hetQIgseswFZgvKu00-DyDFbQiqVDw1s-A&s")',
    ...
    >
      <div className="card-body">
        <form onSubmit={handleSubmit}>
          <center>
            <h1 className="mt-2">Meal Planning</h1>
          </center>
          <div style={{ height: "30px" }}></div>
          <center>
            <h2 className="mt-2">Manage and Plan Your Meals Efficiently</h2>
