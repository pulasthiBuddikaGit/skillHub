...
function Profile(props) {
  ...
  return (
    ...
    <div style={{ backgroundImage: `url('https://i.imgur.com/tYBQuYB.jpeg')`, backgroundSize: 'cover', backgroundPosition: 'center', borderRadius: "10px", boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.1)" }}> 
